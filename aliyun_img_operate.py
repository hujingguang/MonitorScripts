...
def get_img_from_region(region):
...
def __create_image(host_id,img_name,region):
    ...
    if 'Code' in result:
	logging.warn('the image: %s  is be creating now ! please wait' %img_name)
    else:
